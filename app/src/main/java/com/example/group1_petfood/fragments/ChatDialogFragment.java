...
public class ChatDialogFragment extends DialogFragment implements ChatController.ChatListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String userRole = sharedPreferences.getString(KEY_USER_ROLE, "customer");
        isAdmin = "admin".equals(userRole); // Set isAdmin to true if the role is "admin"

        // Initialize ChatController with dynamic userId and isAdmin
        chatController = new ChatController(getContext(), userId, isAdmin, this);
        ...
        binding.sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!messageText.isEmpty()) {
                    // Send the message using ChatController
